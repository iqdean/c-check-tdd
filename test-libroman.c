 ...
 * Edit the original source file "test-libroman.check" instead.
 */

#include <check.h>

#line 1 "test-libroman.check"
#include "romancalc.h"
...
START_TEST(tc3_1_chk_compacted)
{
#line 87
...
START_TEST(tc3_2_chk_uncompacted)
{
#line 99
...
START_TEST(tc4_1_chk_compacted)
{
#line 134
...
START_TEST(tc5_1_chk_invalid_b)
{
#line 211
...
START_TEST(tc5_2_chk_invalid_a)
{
#line 226
...
START_TEST(tc5_3_chk_invalid_ab)
{
#line 241
...
START_TEST(tc5_5_invalidIORange)
{
#line 271
...
START_TEST(tc5_7_validAdditions)
{
#line 303
...
START_TEST(tc6_1_chk_invalid_b)
{
#line 339
...
START_TEST(tc6_2_chk_invalid_a)
{
#line 354
...
START_TEST(tc6_3_chk_invalid_ab)
{
#line 369
...
START_TEST(tc6_5_invalidIORange)
{
#line 400
...
START_TEST(tc6_7_validSubtractions)
{
#line 435
...
int main(void)
{
    Suite *s1 = suite_create("utils");
    TCase *tc1_1 = tcase_create("tc1_chk_for_valid_roman_digit");
    TCase *tc1_2 = tcase_create("tc2_roman2base10");
    TCase *tc1_3 = tcase_create("tc3_toBase10fromRoman");
    TCase *tc1_4 = tcase_create("tc4_toRomanFromBase10");
    Suite *s2 = suite_create("add2Romans");
    TCase *tc2_1 = tcase_create("tc5_add2Romans");
    Suite *s3 = suite_create("subtract2Romans");
    TCase *tc3_1 = tcase_create("tc6_subtract2Romans");
    SRunner *sr = srunner_create(s1);
    int nf;

    suite_add_tcase(s1, tc1_1);
    tcase_add_test(tc1_1, tc1_1_pos_chk);
    tcase_add_test(tc1_1, tc1_2_neg_chk);
    suite_add_tcase(s1, tc1_2);
    tcase_add_test(tc1_2, tc2_1_pos_chk);
    tcase_add_test(tc1_2, tc2_2_neg_chk);
    suite_add_tcase(s1, tc1_3);
    tcase_add_test(tc1_3, tc3_1_chk_compacted);
    tcase_add_test(tc1_3, tc3_2_chk_uncompacted);
    suite_add_tcase(s1, tc1_4);
    tcase_add_test(tc1_4, tc4_1_chk_compacted);
    tcase_add_test(tc1_4, tc4_2_chk_bounds);
    suite_add_tcase(s2, tc2_1);
    tcase_add_test(tc2_1, tc5_1_chk_invalid_b);
    tcase_add_test(tc2_1, tc5_2_chk_invalid_a);
    tcase_add_test(tc2_1, tc5_3_chk_invalid_ab);
    tcase_add_test(tc2_1, tc5_4_chk_valid_ab);
    tcase_add_test(tc2_1, tc5_5_invalidIORange);
    tcase_add_test(tc2_1, tc5_7_validAdditions);
    suite_add_tcase(s3, tc3_1);
    tcase_add_test(tc3_1, tc6_1_chk_invalid_b);
    tcase_add_test(tc3_1, tc6_2_chk_invalid_a);
    tcase_add_test(tc3_1, tc6_3_chk_invalid_ab);
    tcase_add_test(tc3_1, tc6_4_chk_valid_ab);
    tcase_add_test(tc3_1, tc6_5_invalidIORange);
    tcase_add_test(tc3_1, tc6_7_validSubtractions);
